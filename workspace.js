...
cprequire_test(["inline:com-chilipeppr-workspace-marlin"], function(ws) {
    ...
    $('title').html("Marlin Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-marlin", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-marlin", // Make the id the same as the cpdefine id
        name: "Workspace / Marlin", // The descriptive name of your widget.
        desc: `This is a workspace for ChiliPeppr's Hardware Fiddle. It is geared towards CNC machines using Marlin.`,
                ...
                function() {
                    ...
                    cprequire(["inline:com-chilipeppr-widget-serialport"], function(spjs) {
                        ...
                        spjs.init({
                            ...
                            defaultBaud: 19200,
                            bufferEncouragementMsg: 'For your device please choose the "marlin"  buffer in the pulldown and a 115200 baud rate before connecting.'
                        });
                        //spjs.showBody();
                        //spjs.consoleToggle();
